...
public class DBScan2
     ...
     * (default = weka.clusterers.forOPTICSAndDBScan2.DataObjects.EuclidianDataObject)
     */
    private String database_distanceType = "weka.clusterers.forOPTICSAndDBScan2.DataObjects.EuclidianDataObject";

    /**
     * Holds the type of the used database
     * (default = weka.clusterers.forOPTICSAndDBScan2.Databases.SequentialDatabase)
     */
    private String database_Type = "weka.clusterers.forOPTICSAndDBScan2.Databases.SequentialDatabase";

    /**
     * The database that is used for DBScan2
     */
    ...
    /**
     * Generate Clustering via DBScan2
    ...
    public Enumeration listOptions() {
        ...
        vector.addElement(
                new Option("\tminPoints (default = 6)",
                        ...
                        "-M <int>"));
        vector.addElement(
                new Option("\tindex (database) used for DBScan2 (default = weka.clusterers.forOPTICSAndDBScan2.Databases.SequentialDatabase)",
                        "I",
                        1,
                        "-I <String>"));
        vector.addElement(
                new Option("\tdistance-type (default = weka.clusterers.forOPTICSAndDBScan2.DataObjects.EuclidianDataObject)",
                        "D",
                        1,
                        "-D <String>"));
     ...
     *
     * <pre> -I &lt;String&gt;
     *  index (database) used for DBScan2 (default = weka.clusterers.forOPTICSAndDBScan2.Databases.SequentialDatabase)</pre>
     *
     * <pre> -D &lt;String&gt;
     *  distance-type (default = weka.clusterers.forOPTICSAndDBScan2.DataObjects.EuclidianDataObject)</pre>
     *
     <!-- options-end -->
     *
    ...
    public String toString() {
        ...
        stringBuffer.append("DBScan2 clustering results\n" +
                "========================================================================================\n\n");
    ...
    /**
     * Main Method for testing DBScan2
     * @param args Valid parameters are: 'E' epsilon (default = 0.9); 'M' minPoints (default = 6);
     *                                   'I' index-type (default = weka.clusterers.forOPTICSAndDBScan2.Databases.SequentialDatabase);
     *                                   'D' distance-type (default = weka.clusterers.forOPTICSAndDBScan2.DataObjects.EuclidianDataObject);
     */
    public static void main(String[] args) {
        runClusterer(new DBScan2(), args);
    }
}
